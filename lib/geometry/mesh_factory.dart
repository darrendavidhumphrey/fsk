...
/// or populate [FskVertexBuffer] objects from geometry.
class MeshFactory {
  ...
  static void fromSolidFaces(FskVertexBuffer vbo, List<Polyline> faces) {
  ...
  static void tessellateColorOutlines(
      FskVertexBuffer vbo, List<Polyline> outlines, Color color) {
  ...
  static void tessellateOutlines(
      FskVertexBuffer vbo, List<Polyline> outlines, bool generateNormals) {
    _tessellate(vbo, outlines, (filler, outline) {
  ...
  static void _tessellate(FskVertexBuffer vbo, List<Polyline> outlines,
      Function(VboFiller, Polyline) addFunction) {
    int triangleCount = 0;
